 ...
 * in a wide range of applciations, including cell-based AMR codes (CLAMR/xRage), 
 ...
 * 2. Each process requests a set of indices from `nneighbors` neighors, 
 ...
 *    on OpenCL acclerator memory, or in OpenMP 4.5 accelerator memory.
 *
...
enum memspace {MEMSPACE_HOST, MEMSPACE_CUDA, MEMSPACE_OPENCL, MEMSPACE_OPENMP};
...
int main(int argc, char *argv[])
{
    ...
    * and adjust appropriatley so the eventual bandwidth calculation is right */
