...
int main(int argc, char *argv[])
{
   ...
   init_int_array<<<(num_indices_owned + 255)/256, 256>>>(num_indices_owned, my_start_index, idata);
   init_double_array<<<(num_indices_owned + 255)/256, 256>>>(num_indices_owned, my_start_index, rdata);
